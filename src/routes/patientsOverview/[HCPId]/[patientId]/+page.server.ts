...
async function UpdateThreshold(
	...
	/*if (BreathingRateUP != null && BreathingRateLO != null) {
		console.log('BreathingRate', BreathingRateUP, BreathingRateLO);
		patients.updateOne(
			{
				_id: new ObjectId(paramPatient),
				HCProTresholds: { $elemMatch: { HCPro: paramUser } }
	...
	if (BreathingDepthUP != null && BreathingDepthLO != null) {
		console.log('BreathingDepth', BreathingDepthUP, BreathingDepthLO);
		patients.updateOne(
			{
				_id: new ObjectId(paramPatient),
				HCProTresholds: { $elemMatch: { HCPro: paramUser } }
	...
	if (SPO2UP != null && SPO2LO != null) {
		console.log('SPO2', SPO2UP, SPO2LO, paramUser);
		patients.updateOne(
			{
				_id: new ObjectId(paramPatient),
				HCProTresholds: { $elemMatch: { HCPro: paramUser } }
	...
	if (CaughingCountUP != null && CaughingCountLO != null) {
		console.log('CoughingCount', CaughingCountUP, CaughingCountLO);
		patients.updateOne(
			{
				_id: new ObjectId(paramPatient),
				HCProTresholds: { $elemMatch: { HCPro: paramUser } }
	...
	if (HeartRateUP != null && HeartRateLO != null) {
		console.log('HeartRate', HeartRateUP, HeartRateLO);
		patients.updateOne(
			{
				_id: new ObjectId(paramPatient),
				HCProTresholds: { $elemMatch: { HCPro: paramUser } }
	...
	if (ArythmiaCountUP != null && ArythmiaCountLO != null) {
		console.log('ArythmiaCount', ArythmiaCountUP, ArythmiaCountLO);
		patients.updateOne(
			{
				_id: new ObjectId(paramPatient),
				HCProTresholds: { $elemMatch: { HCPro: paramUser } }
	...
	if (BodyTemperatureUP != null && BodyTemperatureLO != null) {
		console.log('BodyTemperature', BodyTemperatureUP, BodyTemperatureLO);
		patients.updateOne(
			{
				_id: new ObjectId(paramPatient),
				HCProTresholds: { $elemMatch: { HCPro: paramUser } }
